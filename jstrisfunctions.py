...
def new_first_last_date(list_of_dates: list) -> tuple:
    ...
    while still_pruning:
        ...
        for j, k in enumerate(list_of_dates):
            ...
            if not list_of_dates[j-1] > k > list_of_dates[j+1]:
                new_list_of_dates.append(k)
            else:
                still_pruning = True
